    ...
    <section className="skills" aria-labelledby="skills-title">
      <section className="skills__section">
        <div className="skills__intro">
          <h2 id="skills-title">{content.skillsPage.codeTitle}</h2>
      ...
      <section className="skills__section" aria-labelledby="skills-list-title">
        <div className="skills__intro">
          <h2 id="skills-list-title">{content.skillsPage.skillsTitle}</h2>
